...
* In Github, fork `https://github.com/c4milo/github-release` to your own account
* Get the package using "go get": `go get github.com/c4milo/github-release`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/c4milo/github-release`
* Add a git remote pointing to your own fork: `git remote add downstream git@github.com:<your_account>/github-release.git`
